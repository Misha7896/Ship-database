...
{
	cout << "Submarines();" << endl;
}

Submarines::Submarines(int length, int width, int TimeUnderWater, int speed, int MaxUnderwaterSpeed, int armament)
{
	cout << "\nSubmarines();" << endl;
	this->length = length;
	this->width = width;
...
Submarines& Submarines::operator=(const Submarines& other)
{
	if (this == &other) return *this;

	this->length = other.length;
	this->width = other.width;
	this->TimeUnderWater = other.TimeUnderWater;
	this->speed = other.speed;
	this->MaxUnderwaterSpeed = other.MaxUnderwaterSpeed;
