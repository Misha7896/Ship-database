...
Boats::Boats(string purpose, string HousingMaterial, int DrivingQualities, int speed, int crew)
{
	cout << "\nBoats();" << endl;
...
Boats& Boats::operator=(const Boats& other)
{
	...
	this->HousingMaterial = other.HousingMaterial;
	this->DrivingQualities = other.DrivingQualities;
